...
public class TeleOpRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            handleAccessoryMotors(reverseMode, intakePressed, dpadUp);
    ...
    private void handleAccessoryMotors(boolean reverseMode, boolean intakePressed, boolean dpadUp) {
        ...
        if (reverseMode) {
            ...
            intakeMotor.setPower(dpadUp ? 0 : 0.0);  // Stop intake when L2 is pressed
        } else {
